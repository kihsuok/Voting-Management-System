...
public class New
{
    ...
    public static void callVoting() throws AgeLessForContestInElextionsException
    {
      Scanner sc=new Scanner(System.in);
      System.out.print("\033[H\033[2J");
    ...
    public static void addCand() throws AgeLessForContestInElextionsException{
      Scanner sc=new Scanner(System.in);
      String Name,str="";
      String Age;
      String Gender;
      ...
      try{
        ...
        System.out.println(e+": Age include alphabets!!!");
      }
    ...
    public static void ECMenu() throws AgeLessForContestInElextionsException
    {
        int flag=0;
        System.out.print("\033[H\033[2J");
        Scanner sc=new Scanner(System.in);
    ...
    public static void main(String[] args) throws AgeLessForContestInElextionsException{
        ECMenu();
    }
}
...
//   public static void main(String args[]){
    ...
    //     }
  //   try {
  //           FileWriter f = new FileWriter("Vot.txt");
  //           f.write(str);
  //           f.close();
